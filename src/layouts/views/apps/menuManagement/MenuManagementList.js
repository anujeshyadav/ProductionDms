...
class MenuManagementList extends React.Component {
  state = {
    rowData: [],
          ...
          return (
            <div className="actions cursor-pointer">
              ...
              <Edit
                className="mr-50"
                size={20}
                onClick={() => history.push("/app/menuManagement/editMenuManagement")}
              />
              <Trash2
                size={20}
                onClick={() => {
            ...
            <Row className="m-2">
              ...
              <Col>
                <Button
                  ...
                  onClick={() =>
                    history.push("/app/menuManagement/addMenuManagement")
                  }>
                  Add Menu
                </Button>
              </Col>
