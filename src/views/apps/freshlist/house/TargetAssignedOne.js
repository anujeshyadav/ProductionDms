...
import { Delete_individualTarget } from "../../../../ApiEndPoint/ApiCalling";
import {
  BsCloudDownloadFill,
...
class TargetAssignedOne extends React.Component {
  ...
  generatePDF(parsedData) {
    ...
    doc.text("Customer Target", 14, 51);
    doc.autoTable({
    ...
    doc.save("CustomerTargetList.pdf");
  }
  ...
  downloadExcelFile(blob) {
    ...
    a.href = url;
    a.download = "CustomerTarget.xlsx";
  ...
  convertCSVtoExcel = () => {
    ...
    Papa.parse(CsvData, {
      complete: (result) => {
        ...
        const excelType = "xls";
        XLSX.writeFile(wb, `CustomerTargetList.${excelType}`);
      },
    });
  };
