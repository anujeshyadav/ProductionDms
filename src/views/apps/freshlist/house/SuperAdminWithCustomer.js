...
class SuperAdminWithCustomer extends React.Component {
                      ...
                      render={({ history }) => (
                        ...
                        >
                          <Eye
                            ...
                            onClick={() =>
                              history.push({
                                pathname: `/app/rupioo/ViewSuperAdminCustomer/${params?.data?._id}`,
                                state: params,
                              })
                            }
                          />
...
export default SuperAdminWithCustomer;
