                  ...
                  <tr>
                    <th>
                      <CustomInput
                        ...
                        name="rHeading1"
                        type="select"
                        placeholder="rHeading1"
                        value={Data?.rHeading1}
                    ...
                    <th>
                      <CustomInput
                        ...
                        name="rHeading2"
                        type="select"
                        placeholder="rHeading2"
                        value={Data?.rHeading2}
                        onChange={handleChange}>
                        <option value="">--Select--</option>
                        {Unit_List?.map((ele) => (
                          <option value={ele?.value}>{ele?.title}</option>
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              ...
                              <Input
                                type="text"
                                name="wProduct_name"
                                placeholder="wProduct_name"
                                value={product?.wProduct_name}
                                onChange={(e) => handleInputChange(e, index)}
                              />
                            </td>
                            <td>
