...
class  expenseList extends React.Component {
    ...
    async Apicalling(id, db) {
        ...
        await PurchaseOrderList(id, db)
            .then((res) => {
                ...
                let userHeading = JSON.parse(localStorage.getItem("Expenseslist"));
    ...
    async componentDidMount() {
        const InsidePermissions = CheckPermission("Expenses List");
                          ...
                          <Route
                            render={({ history }) => (
                              <Button
                                ...
                                onClick={() =>
                                  history.push(
                                    "/app/ajgroup/HRM/RecPLace/expenseForm"
                                  )
                                }>
                                <FaPlus size={15} /> Add Expenses
                              </Button>
                            )}
                          />
                        </span>
