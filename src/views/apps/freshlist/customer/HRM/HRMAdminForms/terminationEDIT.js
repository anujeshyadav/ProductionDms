...
const TerminationEditForm = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        let mydata = response.Termination;
        setData({
          employeeName: mydata?.employeeName?._id,
          terminationType: mydata?.terminationType,
          noticeDate: mydata?.noticeDate,
          terminationDate: mydata?.terminationDate,
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await _Put(UPDATE_TERMINATION, id, data);
...
export default TerminationEditForm;
