...
class SuperAdminWithUser extends React.Component {
                      ...
                      render={({ history }) => (
                        ...
                        >
                          <Eye
                            ...
                            onClick={() =>
                              history.push({
                                pathname: `/app/rupioo/ViewSuperAdminUser/${params?.data?._id}`,
                                state: params,
                              })
                            }
                          />
...
export default SuperAdminWithUser;
