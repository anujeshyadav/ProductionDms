...
import { Hrm_SalaryList, Hrm_SalaryDelete } from "../../../../../ApiEndPoint/Api";
...
class CreateemployeList extends React.Component {
                            ...
                            <div className="actions cursor-pointer">
                                ...
                                {this.state.InsiderPermissions &&
                                    this.state.InsiderPermissions.View && (
                                        <Eye
                                        // /app/ajgroup/HRM/HrmEmploye/EmployeView/
                                            className="mr-50"
                                            size="25px"
                                            color="green"
                                            onClick={() =>
                                                this.props.history.push({
                                                    pathname: `/app/ajgroup/HRM/HrmEmploye/EmployeView/${params.data?._id}`,
                                                    state: params.data,
                                                })
                                            }
                                        />
                                ...
                                {this.state.InsiderPermissions.View && (
                                    ...
                                    onClick={() =>
                                        this.props.history.push({
                                            pathname: `/app/ajgroup/HRM/HrmEmploye/EmployeEdit/${params.data?._id}`,
                                            state: params.data,
                                        })
                                    }
                                    />
    ...
    async Apicalling(id, db) {
        ...
        await _GetList(Hrm_SalaryList, id, db)
            .then((res) => {
