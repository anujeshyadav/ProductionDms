              ...
              {/* <Media body> */}
                ...
                <div className="d-flex user-info">
                  ...
                  <div className="d-flex user-info">
                    ...
                    <div>{this.state.data.address_line1},{this.state.data.address_line2}</div>
                  </div>
                  <div className="d-flex user-info">
                    <div className="user-info-title font-weight-bold">
                    Store Description
                  ...
                  <div className="d-flex user-info">
                    ...
                    <div>{this.state.data.openingTym}-{this.state.data.closingTym}</div>
                  </div>
                  {/* <div className="d-flex user-info">
                    <div className="user-info-title font-weight-bold">
                      Mobile No
                ...
                <Col className="pl-0" sm="12" lg="6">
                  {/* <Media className="d-sm-flex d-block">
                    <Media className="mt-md-1 mt-0" left> */}
                      ...
                      <Container>
                        <Carousel>
                        {this.state.data?.shoplogo_img?.map(i => (
                          <img
                      ...
                      {/* </Col> */}
                        ...
                        <Container>
                        <Carousel>
                        {this.state.data?.storepan_img?.map(i => (
                          <img
                            className="rounded mr-2"
                            object
                            src={i}
                        ...
                        <Container>
                        <Carousel>
                        {this.state.data?.tradelicence_img?.map(i => (
                          <img
                            className="rounded mr-2"
                            object
                            src={i}
                        ...
                        <Container>
                        <Carousel>
                        {this.state.data?.companypan_img?.map(i => (
                          <img
                            className="rounded mr-2"
                            object
                            src={i}
                        ...
                        <Container>
                        <Carousel>
                        {this.state.data?.address_proof_img?.map(i => (
                          <img
                            className="rounded mr-2"
                            object
                            src={i}
