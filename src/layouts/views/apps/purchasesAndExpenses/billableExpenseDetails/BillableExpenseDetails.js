...
class BillableExpenseDetails extends React.Component {
  state = {
    rowData: [],
            ...
            <Row className="m-2">
              ...
              <Col>
                <Button
                  ...
                  onClick={() =>
                    history.push(
                      "/app/purchasesAndExpenses/billableExpenseDetails/addBillableExpenseDetails"
                    )
                  }>
                  Add Billable Expense Details
                </Button>
              </Col>
            </Row>
            <CardBody>
