...
const JoForm = () => {
  ...
  useEffect(() => {
    ...
    fetchJobCategories(user?.database);
    ...
    _Get(Hrm_ViewOne, id)
      .then((response) => {
        ...
        setData({
          ...
          jobCategory: data?.jobCategory?._id,
  ...
  //         try {
  //             const response = await _Get(HRM_JOB_CAT_BYID, id);
  //             setData(response.JobCategory);
  //         } catch (error) {
  //             console.log(error);
  //         }
  //     };
  ...
  const handleCreateBranch = async (e) => {
    ...
    try {
      ...
      console.log(res);
      toggleBranchModal();
      await getBranches(user?.database);
              ...
              <FormGroup>
                ...
                <ReactQuill
                  ...
                  onChange={(e) => {
                    setData((pre) => {
                      let list = pre;
                      list.jobDescription = e;
                      list.jobTitle = list?.jobTitle;
                      list.branch = list?.branch?._id;
                      list.jobCategory = list?.jobCategory?._id;
                      list.numberOfPositions = list?.numberOfPositions;
                      list.status = list?.status;
                      list.startDate = list?.startDate;
                      list.endDate = list?.endDate;
                      list.skills = list?.skills;
                      list.jobRequirements = list?.jobRequirements;
                      return list;
                    });
                  }}
            ...
            <Col md={6}>
              <FormGroup>
                ...
                <ReactQuill
                  // required
                  theme="snow"
                  value={data?.jobRequirements && data?.jobRequirements}
                  onChange={(e) => {
                    console.log(e);

                    setData((pre) => {
                      let list = pre;
                      list.jobDescription = list?.jobDescription;
                      list.jobTitle = list?.jobTitle;
                      list.branch = list?.branch?._id;
                      list.jobCategory = list?.jobCategory?._id;
                      list.numberOfPositions = list?.numberOfPositions;
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.gender
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.dateOfBirth
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.address
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.profileImage
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.resume
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.coverLetter
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    <Input
                      ...
                      checked={customFormData.termsAndConditions}
                      onChange={() =>
                        handleCustomInputChange("termsAndConditions")
                      }
                    />
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.termsAndConditions
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.weakness
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.jobReason
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
                ...
                <FormGroup check>
                  <Label check>
                    ...
                    <span
                      className="checkmark"
                      style={{
                        backgroundColor: customFormData.companyReason
                          ? "green"
                          : "transparent",
                      }}
                    ></span>
